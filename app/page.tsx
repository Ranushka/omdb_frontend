...
export default function Home() {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <header role="banner">
        <p className="container mx-auto pt-8 px-8 text-xl font-bold">
          <a href="/">Search OMDB Movies</a>
        </p>
      </header>
      <SearchProvider>
        <div className="container mx-auto p-0 lg:p-8 lg:h-[calc(100vh-80px)]">
          ...
          <div className="flex flex-col lg:flex-row h-full">
            ...
            <main
              role="main"
              className="lg:w-2/3 w-full lg:static inset-0 bg-gray-100 h-auto lg:h-full"
            >
              <MovieDetail />
            </main>
          </div>
